...
All notable changes to Chronoglyph will be documented in this file. The format follows [Keep a Changelog](https://keepachangelog.com/en/1.1.0/), and the project uses semantic versioning while its public API remains pre-1.0.
...
- Dedicated authored-scene stylesheet export.
- Public timeline validation, unique per-stage SVG filter IDs, and phase-tab keyboard navigation.
